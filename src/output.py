...
class Output:
    ...
    def __init__(
        self, console: Console, color: Style, reasoning_color: Style, theme: str
    ):
        self.full_response = ""
    ...
    def print(self, text: str, reasoning_text: bool = False) -> None:
        ...
        color = self.color if not reasoning_text else self.reasoning_color
